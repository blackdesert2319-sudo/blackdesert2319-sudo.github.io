export const QUESTIONS = [
  {
    "type": "choice",
    "text": "Cho vector $\\vec{a} = (2; -1; 3)$. Độ dài của $\\vec{a}$ bằng:",
    "options": {
      "A": "$\\sqrt{14}$",
      "B": "$\\sqrt{10}$",
      "C": "$\\sqrt{12}$",
  ...
  {
    "type": "choice",
    "text": "Cho 2 điểm $A(2; 1; -1)$, $B(1; -3; 4)$. Vector $\\overrightarrow{AB}$ bằng:",
    "options": {
      "A": "$(1; 4; -5)$",
      "B": "$(-1; -4; 5)$",
      "C": "$(-1; -4; -5)$",
  ...
  {
    "type": "choice",
    "text": "Điểm $M'(x; y; z)$ đối xứng với $M(4; -3; 5)$ qua trục $Oy$ là:",
    "options": {
      "A": "$(4; -3; -5)$",
      "B": "$(-4; -3; -5)$",
      "C": "$(-4; -3; 5)$",
